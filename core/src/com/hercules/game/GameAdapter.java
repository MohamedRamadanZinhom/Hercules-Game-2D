...
public class GameAdapter extends ApplicationAdapter {
	...
	public void create() {
		...
		// Test AnimationGenerator
		try {
			AnimationGenerator.addAnimation(name, path, nFrame, frameDuration, 
												startKeys, endKeys, typeKeys);
		...
		System.out.println(envCam.position.x);
//		playerCam = new OrthographicCamera(100, 100); 
//		playerCam.setToOrtho(false, x - initial_zoom_level, y * 2.25f - initial_zoom_level);
...
//		/////////////// Handle Inputs //////////////
		...
		AnimationGenerator.animate(name, mode, stateTime, x_postion, y_postion);
